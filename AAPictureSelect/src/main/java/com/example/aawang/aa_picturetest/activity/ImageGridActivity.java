...
import com.example.aawang.aa_picturetest.AlbumHelper;
import com.example.aawang.aa_picturetest.adapter.ImageSelectGridAdapter;
import com.example.aawang.aa_picturetest.ImageItem;
...
public class ImageGridActivity extends Activity {
	...
	GridView gridView;
	ImageSelectGridAdapter adapter;// 鑷畾涔夌殑閫傞厤鍣�
	AlbumHelper helper;
	Button bt;
	...
	private void initView() {
		...
		adapter = new ImageSelectGridAdapter(ImageGridActivity.this, dataList,
				mHandler);
		gridView.setAdapter(adapter);
		adapter.setTextCallback(new ImageSelectGridAdapter.TextCallback() {
