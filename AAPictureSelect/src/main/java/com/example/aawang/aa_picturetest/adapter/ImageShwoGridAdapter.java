...
public class ImageShwoGridAdapter extends BaseAdapter {
    ...
    public ImageShwoGridAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_main_griditem,
                    parent, false);
