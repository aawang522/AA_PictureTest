package com.example.aawang.aa_picturetest.adapter;
...
import com.example.aawang.aa_picturetest.BitmapCache;
...
public class ImageSelectGridAdapter extends BaseAdapter {
	...
	public ImageSelectGridAdapter(Activity act, List<ImageItem> list, Handler mHandler) {
		this.act = act;
		dataList = list;
